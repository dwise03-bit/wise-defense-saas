...
function CheckoutContent() {
  ...
  return (
    <section className="min-h-[calc(100vh-80px)] flex items-center justify-center px-6 py-12 bg-gray-50">
      <div className="max-w-md w-full">
        ...
        {status === 'success' && (
          <div className="bg-white rounded-2xl p-8 text-center border border-green-200">
            <div className="mb-6">
        ...
        {status === 'cancelled' && (
          <div className="bg-white rounded-2xl p-8 text-center border border-gray-200">
            ...
            <p className="text-gray-600 mb-6">Your subscription was not completed. No charges were made.</p>
            <Link href="/pricing">
...
export default function CheckoutPage() {
  return (
    <main className="bg-white min-h-screen flex flex-col">
      {/* Header */}
      <header className="border-b border-gray-200 px-6 h-16 flex items-center">
